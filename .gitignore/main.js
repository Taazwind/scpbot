...
bot.on('message', message => {
    ...
    if (message.content === prefix + "info 527"){
        var scp_527 = new Discord.RichEmbed()
            ...
            .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-527")
    ...
    if (message.content === prefix + "info 682"){
        var scp_682 = new Discord.RichEmbed()
            ...
            .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-682")
    ...
    if (message.content === prefix + "info 914"){
        var scp_914 = new Discord.RichEmbed()
           ...
           .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-914")
    ...
    if (message.content === prefix + "info 106"){
        var scp_106 = new Discord.RichEmbed()
           ...
           .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-106")
    ...
    if (message.content === prefix + "info 006-fr"){
        var scp_006fr = new Discord.RichEmbed()
            ...
            .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-006-fr")
    ...
    if (message.content === prefix + "info 011-fr"){
        var scp_011fr = new Discord.RichEmbed()
            ...
            .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-011-fr")
    ...
    if (message.content  === prefix + "info 060-fr"){
        var scp_060fr = new Discord.RichEmbed()
            ...
            .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-060-fr")
    ...
    if (message.content === prefix + "info 173"){
        var scp_173 =new Discord.RichEmbed()
            ...
            .setFooter("Voir la page wiki complète: http://fondationscp.wikidot.com/scp-173")
