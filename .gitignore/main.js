...
bot.on('message', message => {
    ...
    if (message.content === prefix + "info 527"){
        var scp_527 = new Discord.RichEmbed()
            ...
            .addField("Le Wiki", "Voir la page wiki complète: [SCP-527]http://fondationscp.wikidot.com/scp-527", true)
    ...
    if (message.content === prefix + "info 682"){
        var scp_682 = new Discord.RichEmbed()
            ...
            .addField("Le Wiki", "Voir la page wiki complète: [SCP-682]http://fondationscp.wikidot.com/scp-682", true)
    ...
    if (message.content === prefix + "info 914"){
        var scp_914 = new Discord.RichEmbed()
           ...
           .addField("Le Wiki", "Voir la page wiki complète: [SCP-914]http://fondationscp.wikidot.com/scp-914", true)
    ...
    if (message.content === prefix + "info 106"){
        var scp_106 = new Discord.RichEmbed()
           ...
           .addField("Le Wiki", "Voir la page wiki complète: [SCP-106]http://fondationscp.wikidot.com/scp-106", true)
    ...
    if (message.content === prefix + "info 006-fr"){
        var scp_006fr = new Discord.RichEmbed()
            ...
            .addField("Le Wiki", "Voir la page wiki complète: [SCP-006-FR]http://fondationscp.wikidot.com/scp-006-fr", true)
    ...
    if (message.content === prefix + "info 011-fr"){
        var scp_011fr = new Discord.RichEmbed()
            ...
            .addField("Le Wiki", "Voir la page wiki complète: [SCP-011]http://fondationscp.wikidot.com/scp-011-fr", true)
    ...
    if (message.content  === prefix + "info 060-fr"){
        var scp_060fr = new Discord.RichEmbed()
            ...
            .addField("Le Wiki", "Voir la page wiki complète: [SCP-060-FR]http://fondationscp.wikidot.com/scp-060-fr", true)
