...
bot.on('message', message => {
    ...
    if (message.content === prefix + "info 1074"){
        ...
        var scp_1074 = new Discord.RichEmbed()
            .setColor('#07A48F')
        var scp_1074_2 = new Discord.RichEmbed()
        .setColor('#07A48F')
        .addField("**Description**:(10)","L'individu continuera généralement à décrire l'œuvre observée dans les moindres détails, et dira la voir dans ses rêves, lorsqu'il ferme ses yeux ou cligne, et dans sa vision périphérique lorsqu'il est éveillé. La confusion, la dissociation, et la catatonie s'ensuivent en moyenne 5 à 8 jours après l'exposition à l'effet; plus l'individu aura été exposé longtemps à SCP-1074.")
        .addField("**Description**:(11)", "Moins il faudra de temps pour que la catatonie s'ensuive.")
        .addField("**Description**:(12)","Les amnésiques de Classe A sont capables d'effacer toute mémoire de l'image, et de ramener l'individu dans un état mental stable. Dans tous les cas, ceci n'est que temporaire; l'individu signalera des souvenirs de l'image, ainsi que les problèmes mentaux associés aux effets de SCP-1074, pendant la semaine suivant la prise des amnésiques.")
        .addField("**Description**:(13)","Les doses d'amnésiques, si données à la suite, feront de moins en moins d'effet, jusqu'à ne plus pouvoir faire oublier l'œuvre à l'individu affecté; La plus longue période enregistrée entre l'exposition d'un individu à SCP-1074 et la manifestation de la catatonie est 6 semaines et 4 jours.")
        .addField("**Description**:(14)","SCP-1074 se fit connaître par la Fondation le ██/██/20██, après qu'il fut signalé depuis la Galerie du █████████, en [DONNÉES CENSURÉES], qu'une grande partie des gens entrant à l'intérieur ressortaient hystériques, et que beaucoup de personnes n'en ressortaient pas.")
        .addField("**Description**:(15)","Après que la première équipe de confinement soit envoyée et exposée aux effets de SCP-1074, celui-ci fut récupéré par robot télécommandé.")
        .addField("**Description**:(16)", "Les membres du personnel de direction de la galerie affirmèrent que l'exhibition de l'œuvre, intitulée \"Le Cauchemar de Stendhal\", avait été arrangée indirectement par l'agent de l'artiste, qu'elle avait été amenée la veille de l'exposition par des personnes employées par l'agent en question, et qu'elle avait été couverte par un voile jusqu'à ce que l'exposition ne commence.")
        .addField("**Description**:(17)", "Toutes les informations données par le personnel de la galerie afin de contacter l'artiste et son agent étaient frauduleuses.")
        .addField("Le Wiki", "Voir la page complète: \n [SCP-1074](http://fondationscp.wikidot.com/scp-1074)", true)
        message.channel.sendEmbed(scp_1074_2);
